...
// // const vcms = mongoose.model("vcms", userSchema);  // enter it
// // module.exports = mongoose.model("vcms", userSchema);
// // module.exports = User;
// // module.exports = User;
 
// // ✅ Export Models
// module.exports = vcms;
// module.exports = {user, Client, Booking, VCBooking }; // enter new vcms
